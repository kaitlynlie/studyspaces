...
const TodoDialog = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      const updatedTodos = [...todos, response.data]; // Create a new array with the new item
      console.log(updatedTodos); // Check if the new item is included in the updatedTodos array
