...
const Navbar = () => {
  ...
  useEffect(() => {
    // Retrieve timer state from localStorage on component mount
    ...
    if (storedTimeRemaining !== null && storedIsRunning !== null && storedCustomTime !== null) {
      setTimeRemaining(parseInt(storedTimeRemaining));
      setIsRunning(storedIsRunning === 'true');
      setCustomTime(storedCustomTime);
    }
  }, []);
  ...
  useEffect(() => {
    // Update localStorage whenever timer state changes
    localStorage.setItem('timeRemaining', timeRemaining);
    localStorage.setItem('isRunning', isRunning);
    localStorage.setItem('customTime', customTime);
  }, [timeRemaining, isRunning, customTime]);
